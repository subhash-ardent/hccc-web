...
export class CourseFormComponent implements OnInit {
  ...
  createForm(c: Course): FormGroup {
    ...
    return this.formBuilder.group({
      courseId: [c.courseId],
      courseName: [c.courseName, {updateOn: 'blur', validators: Validators.required}, ],
      courseImageURL: [c.courseImageURL, {updateOn: 'blur', validators: Validators.required}],
      courseEndTime: [c.courseEndTime, {updateOn: 'blur', validators: Validators.required}],
      courseStartTime: [c.courseStartTime, {updateOn: 'blur', validators: Validators.required}],
      courseStartDate: [c.courseStartDate, {updateOn: 'blur', validators: Validators.required}],
      courseEndDate: [c.courseEndDate, {updateOn: 'blur', validators: Validators.required}],
      slots: [c.slots, {updateOn: 'blur', validators: Validators.required}],
      courseVenue: [c.courseVenue, {updateOn: 'blur', validators: Validators.required}],
      ...
      courseDays: [c.courseDays, {updateOn: 'blur', validators: Validators.required}],
